...
const Page = () => {
	...
	return (
		<div
			className={cn(
				"relative h-full flex-1 my-16 w-full rounded-xl bg-gray-900/30 p-2 ring-inset ring-gray-900/10 lg:rounded-2xl flex justify-center flex-col items-center",
